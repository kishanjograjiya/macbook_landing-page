<div align="center">
  <br />
    <img src="public/readme/project-banner.webp" alt="Project Banner">
  <br />
...
```bash
git clone https://github.com/kishanjograjiya/macbook_landing-page.git
cd macbook_landing-page
```
